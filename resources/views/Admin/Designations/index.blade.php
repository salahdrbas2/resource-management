                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Designation Informations</h3>
                        </div>
                        <!-- /.card-header -->
                        ...
                        <form action="{{ route('Designations.search') }}" method="POST" style="margin-left:65%; margin-top:-45px;">
                            @csrf
                            ...
                            <a href="{{ route('Designations.index') }}"><button type="button" class="btn btn-info btn-sm"><i class="fas fa-redo"></i></button></a>
                        </form>
                        <div class="card-body">
                            <table id="datatable"  class="table table-bordered table-striped">
                                ...
                                @foreach ($Designations as $Designation)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                    data-target="#edit{{$Designation->id}}"
                                                    title=""><i class="fa fa-edit"></i></button>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#delete{{$Designation->id}}"
                                                    title=""><i
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <!-- add_form -->
                                                    <form action="{{ route('Designations.update', 'test') }}" enctype="multipart/form-data" method="post">
                                                        {{ method_field('put') }}
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col">
                                                                <label for="position_skill"
                                                                       class="mr-sm-2">Designation
                                                                    :</label>
                                    ...
                                    <!-- delete_modal_Grade -->
                                    <div class="modal fade" id="delete{{ $Designation->id }}" tabindex="-1" role="dialog"
                                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('Designations.destroy', 'test') }}" method="post">
                                                        {{ method_field('Delete') }}
                                                        @csrf
                                                        Are you sure delete ?
                                                        <input id="id" type="hidden" name="id" class="form-control"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('Designations.store') }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="Designation" class="mr-sm-2">Designation
                                        :</label>
